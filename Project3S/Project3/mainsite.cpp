...
void show_content_stack() {
	...
	cout << "<h3> Введите математическре выражение: </h3>";
...
void show_content_queue() {
	...
	cout << "<h4>Введите название файла из которого надо считать список: </h4>";
...
void show_content_LinkedList() {
	...
	cout << "<h6> Введите два числа, через пробел, которые нужно сложить: </h6>";
	cout << "<form method='get' action='mainsite.cgi'>";
